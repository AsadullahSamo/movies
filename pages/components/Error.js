    ...
    <>
      ...
      <div className='bg-black min-h-screen'>
        ...
        <div className='flex flex-col items-center justify-center mt-36 gap-5'>
          ...
          <button className={`bg-yellow-500 w-32 h-12 rounded-md hover:cursor-pointer border-2 hover:border-white hover:bg-black hover:text-white transition-all duration-500 text-[20px] text-center ${fonts.latoMeduim} py-2 px-3`} onClick={handleRefresh}> Refresh </button>
        </div>
      </div>
    </>
